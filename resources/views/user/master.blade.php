...
<!-- Mirrored from demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jan 2023 10:50:52 GMT -->
...
<head>
    ...
    <link href="{{asset('/')}}users/css/nucleo-icons.css" rel="stylesheet" />
    <link href="{{asset('/')}}users/css/nucleo-svg.css" rel="stylesheet" />

    <script src="..{{asset('/')}}users/../../kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="{{asset('/')}}users/css/nucleo-svg.css" rel="stylesheet" />

    <link id="pagestyle" href="{{asset('/')}}users/css/soft-ui-dashboard.minf2ad.css?v=1.0.7" rel="stylesheet" />
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="dashboard.html" target="_blank">
            <span class="ms-1 font-weight-bold">PhoneBook Dashboard</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('user.add-contact')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Add Contact</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{route('user.contact-list')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">Logout</a>
...
<script src="..{{asset('/')}}users/assets/js/core/popper.min.js"></script>
<script src="..{{asset('/')}}users/assets/js/core/bootstrap.min.js"></script>
<script src="..{{asset('/')}}users/assets/js/plugins/perfect-scrollbar.min.js"></script>
<script src="..{{asset('/')}}users/assets/js/plugins/smooth-scrollbar.min.js"></script>
...
<script async defer src="{{asset('/')}}users/buttons.github.io/buttons.js"></script>

<script src="{{asset('/')}}users/assets/js/soft-ui-dashboard.minf2ad.js?v=1.0.7"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"783b2cd02adb4733","version":"2022.11.3","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jan 2023 10:51:13 GMT -->
</html>
