        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('user.create-contact')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="horizontal-password-input" name="number"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Create New Contact</button>
                                </div>
                            </div>
                        </div>
                    </form>
